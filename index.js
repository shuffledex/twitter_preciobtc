...
cron.schedule('0 */3 * * *', function(){
	...
	refSitios.on("value", function(snapshot) {
		...
		var msgBestTransferencia = "Por Transferencia Bancaria el mejor precio de Compra lo encontrás en " + bestTransferencia[0].twitter + " a " + bestTransferencia[0].buy.toFixed(2) + " ARS (FEES INCLUIDOS).";
		var msgBestMercadopago = "Por Mercadopago el mejor precio de Compra lo encontrás en " + bestMercadopago[0].twitter + " a " + bestMercadopago[0].buy.toFixed(2) + " ARS (FEES INCLUIDOS).";
		var msgBestRapipago = "Por Rapipago/Pagofacil el mejor precio de Compra lo encontrás en " + bestRapipago[0].twitter + " a " + bestRapipago[0].buy.toFixed(2) + " ARS (FEES INCLUIDOS).";
		var msgBestWallet = "Por Wallet el mejor precio de Venta lo encontrás en " + bestWallet[0].twitter + " a " + bestWallet[0].sell.toFixed(2) + " ARS (FEES INCLUIDOS).";
		var msgBestDeposito = "Por Depósito Bancario el mejor precio de Venta lo encontrás en " + bestDeposito[0].twitter + " a " + bestDeposito[0].sell.toFixed(2) + " ARS (FEES INCLUIDOS).";
		var msgBestSellMercadopago = "Por Mercadopago el mejor precio de Venta lo encontrás en " + bestSellMercadopago[0].twitter + " a " + bestSellMercadopago[0].sell.toFixed(2) + " ARS (FEES INCLUIDOS).";
